...
void LoseScene::Initialize() {
	...
	int halfW = w / 2;
	int halfH = h / 2;
	AddNewObject(new Engine::Image("lose/voldemort.jpg", halfW, halfH, 0, 0, 0.5, 0.5));
    ...
    bgmInstance = AudioHelper::PlaySample("harryLose.ogg", false, AudioHelper::BGMVolume, PlayScene::DangerTime);
}
